...
* [REACT] [TYPESCRIPT] [WEBPACK] [JAVASCRIPT] [HTML] [CSS]
...
<!-- ABOUT THE PROJECT   -->
## About The Project
A Slice demo that helps understand better how to dynamically render components and use to build low code solutions or ideas for faster generation of dynamic components.
